        ...
        <div className="relative">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute top-2 sm:top-4 right-2 sm:right-4 bg-black/50 backdrop-blur-md border border-white/10 rounded-lg p-2 sm:p-3 shadow-lg"
            >
            ...
            <motion.div
              ...
              className="absolute bottom-2 sm:bottom-4 left-2 sm:left-4 bg-black/50 backdrop-blur-md border border-white/10 rounded-lg p-2 sm:p-3 shadow-lg"
            >
              <div className="flex items-center gap-1 sm:gap-2">
...
export default AboutRightImage;
