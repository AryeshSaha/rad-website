const testimonials = [
  {
    quote:
      "RAD Media Solutions has completely transformed how we manage our projects. The AI features are genuinely helpful and the interface is beautiful.",
  ...
  {
    quote:
      "We've seen a 40% increase in productivity since implementing RAD's solutions. The automation features alone have saved us countless hours.",
    author: "Michael Chen",
